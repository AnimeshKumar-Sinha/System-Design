...
//
/*
 * Sample Scenario: When a company assign new task to an employees, After the completation of task, employee sets the status to close. 
 * The first thread pulls new tasks after that it is put on the list. When the number of tasks exceeds 10 it gives the warning this
